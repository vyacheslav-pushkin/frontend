...
export interface EffectivePermsInfo {
  ...
  defaultValues: {
    entityCreate?: EntityPermissionValue | null,
    entityRead?: EntityPermissionValue | null,
    entityUpdate?: EntityPermissionValue | null,
    entityDelete?: EntityPermissionValue | null,
    entityAttribute?: AttributePermissionValue | null,
    specific?: EntityPermissionValue | null
  };
